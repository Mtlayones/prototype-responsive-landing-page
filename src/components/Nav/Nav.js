    ...
    return (
        <nav className={styles.nav_custom}>
            ...
            <ul
                ...
                ref={componentRef}>
                <li className="w-full flex justify-center"><button className={styles.button_tertiary}>HOME</button></li>
                <li className="w-full flex justify-center"><button className={styles.button_tertiary}>ABOUT US</button></li>
